...
public class Assignment10Part1 {
    ...
    /* Supported operators string by priority (0 - highest priority)*/
    private static final String OPERATORS = OP_EXP + OP_MUL + OP_DIV + OP_SUB + OP_ADD;

    /*******************************************************************************************************************
     * Performs calculation of given expression
     * with  input arguments
     * @param args array of strings ([0] - expression, other variables values)
     */
    ...
    private static String calculate(ArrayList<String> splittedExpression, Variables vars) {
        ...
        if (splittedExpression.size() == 1) {
            /* expresiion consists of one argument*/
